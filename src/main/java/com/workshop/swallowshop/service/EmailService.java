...
public class EmailService {
	...
	private String verifyURL = "http://localhost:8080/clientes/verificacao?code=";
	
	public void verificadorDeEmail(Cliente cliente) throws Exception {
		
		String toAdress = cliente.getEmail();
		String nome = "Swallow-shop";
		String emailRemetente = "Swallowshop@gmail.com";
		String menssagemDeVerificacao = "Por favor registre o seu email";
		...
		helper.setFrom(emailRemetente, nome);
		helper.setFrom(toAdress);
	    helper.setSubject(menssagemDeVerificacao);
	    
	    content = content.replace("[[NAME]]", cliente.getNome());
	    
	    String verifyURL = this.verifyURL + cliente.getVerificacao();
	    
	    content = content.replace("[[URL]]", verifyURL);
	    
	    helper.setText(menssagemDeVerificacao, true);
